...
fun parseParamIsland(
    json: JSONObject,
    picFunction: String? = null,
    aodPic: String? = null,
): ParamIsland {
    val small =
        json.optJSONObject("smallIslandArea")?.let { parseSmallIslandArea(it) }
...
private val SECONDARY_TEXT_KEYS =
    arrayOf(
        "content",
        "secondaryText",
        "subTitle",
