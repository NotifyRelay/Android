...
data class BImageText2(
    ...
    override val kind: String = "imageText2"
}
...
data class BImageText3(
    ...
    override val kind: String = "imageText3"
}
...
data class BImageText4(
    ...
    override val kind: String = "imageText4"
}
...
data class BImageText6(
    ...
    override val kind: String = "imageText6"
}
...
data class BTextInfo(
    ...
    override val kind: String = "textInfo"
}
...
data class BFixedWidthDigitInfo(
    ...
    override val kind: String = "fixedWidthDigitInfo"
}

/**
 * 等宽数字文本组件（sameWidthDigitInfo）
 * - digit 与 timer 二选一，至少一项存在
 * - content 可选
 * - showHighlightColor 可选
 */
data class BSameWidthDigitInfo(
    ...
    override val kind: String = "sameWidthDigitInfo"
}
...
data class BProgressTextInfo(
    ...
    override val kind: String = "progressTextInfo"
}
...
data class BPicInfo(
    ...
    override val kind: String = "picInfo"
}

// 空
object BEmpty : BComponent {
