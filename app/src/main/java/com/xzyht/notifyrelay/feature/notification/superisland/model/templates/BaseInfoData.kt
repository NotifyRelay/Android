...
fun parseBaseInfo(json: JSONObject): BaseInfo {
    return BaseInfo(
        ...
        extraTitle = json.optString("extraTitle").takeIf { it.isNotEmpty() },
        specialTitle = json.optString("specialTitle").takeIf { it.isNotEmpty() },
        ...
        colorExtraTitle = json.optString("colorExtraTitle").takeIf { it.isNotEmpty() },
        colorExtraTitleDark = json.optString("colorExtraTitleDark").takeIf { it.isNotEmpty() },
        colorSpecialTitle = json.optString("colorSpecialTitle").takeIf { it.isNotEmpty() },
        colorSpecialTitleDark = json.optString("colorSpecialTitleDark").takeIf { it.isNotEmpty() },
        colorSpecialBg = json.optString("colorSpecialBg").takeIf { it.isNotEmpty() },
