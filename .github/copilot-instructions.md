...
### 应用工具方法规范
在使用工具方法前，请先查看 `app\src\main\java\com.xzyht.notifyrelay.common.core\util` 中的实现。如果已有类似功能的方法，请优先使用现有方法，避免重复实现。如果没有合适的方法，可以根据项目的代码风格和规范自行实现新的工具方法，并将其添加到该目录中以供后续使用。注意,新方法如果仅是对旧方法的拓展,请在旧方法的基础上进行修改,而不是新建一个类似的方法。
